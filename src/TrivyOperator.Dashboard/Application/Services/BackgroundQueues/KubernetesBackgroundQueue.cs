...
public class KubernetesBackgroundQueue<TKubernetesObject> : IKubernetesBackgroundQueue<TKubernetesObject>
    where TKubernetesObject : IKubernetesObject<V1ObjectMeta>
{
    private readonly ILogger<KubernetesBackgroundQueue<TKubernetesObject>> logger;
    private readonly Channel<IWatcherEvent<TKubernetesObject>> queue;

    public KubernetesBackgroundQueue(IOptions<BackgroundQueueOptions> options, ILogger<KubernetesBackgroundQueue<TKubernetesObject>> logger)
    {
        this.logger = logger;
